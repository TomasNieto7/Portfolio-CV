...
const Inicio = () => {
    return (
        <div className="h-[100vh] w-full relative" id='inicio'>
            ...
            <div className="absolute w-full h-full flex flex-col items-center justify-center z-50">
                <p className="text-[2rem] h-[6rem] text-white sm:text-[3rem] sm:mb-2 md:text-[4rem] md:mb-6 lg:text-[5rem] lg:mb-10">Bienvenid@s a mi sitio</p>
                <Link href={"#contact"}>
